...
5. Plot some other combinations of PC5-PC10. What can you observe with respect to the separation of populations on the plots (is it better or worse compared to PC1-PC4 plots)? Why?
